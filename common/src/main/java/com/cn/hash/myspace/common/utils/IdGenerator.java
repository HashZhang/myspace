...
public class IdGenerator {
    ...
    public static String getID(String sys) {
        ...
        return new StringBuilder().append(String.format(SYSTEM_SHARD_FORMAT, threadLocalRandom.nextInt(systemShard.get(sys)))).append(String.format(SYSTEM_FORMAT, system.get(sys))).append(uuid.toString().replaceAll("-", "_")).toString();
    }
}
